class ListingsController < ApplicationController
  def index
    ...
    @listings = @q.result(:distinct => true).includes(:hostphotos, :hostpolicies, :availibiliities, :hostlistings, :requests, :listingreviews, :bookmarks).page(params[:page]).per(10)
